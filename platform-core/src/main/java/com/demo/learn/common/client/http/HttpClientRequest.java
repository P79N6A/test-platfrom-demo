...
public class HttpClientRequest<T> extends MessageEntity<T> implements ClientRequest {
    ...
    private static class DefaultBodyBuilder implements BodyBuilder {
        ...
        public BodyBuilder acceptCharset(Charset... acceptableCharsets) {
            this.headers.acceptCharset(Arrays.asList(acceptableCharsets));
            return this;
        }

        @Override
        public BodyBuilder header(HttpHeader header) {
            this.headers.addHeaders(header.getHeaders());
            return this;
        }
